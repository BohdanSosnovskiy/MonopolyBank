...
@dso_cache = dso_local local_unnamed_addr global [462 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 759939925, ; hash 0x2d4bc355, from name: aot-HelloApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1579832150, ; hash 0x5e2a5356, from name: libaot-HelloApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HelloApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 155
	...
	%struct.DSOCacheEntry {
		i64 1997554412, ; hash 0x771042ec, from name: Plugin.NFC.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2851649503, ; hash 0xa9f8b7df, from name: Plugin.NFC
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.20_name, ; name: libaot-Plugin.NFC.dll.so
		ptr null; void* handle (0x0)
	}, ; 305
	...
	%struct.DSOCacheEntry {
		i64 3097401781, ; hash 0xb89e99b5, from name: libaot-Plugin.NFC
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.20_name, ; name: libaot-Plugin.NFC.dll.so
		ptr null; void* handle (0x0)
	}, ; 341
	...
	%struct.DSOCacheEntry {
		i64 3145157391, ; hash 0xbb774b0f, from name: aot-HelloApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HelloApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 350
	...
	%struct.DSOCacheEntry {
		i64 3363749000, ; hash 0xc87ebc88, from name: libaot-Plugin.NFC.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.20_name, ; name: libaot-Plugin.NFC.dll.so
		ptr null; void* handle (0x0)
	}, ; 366
	...
	%struct.DSOCacheEntry {
		i64 3425720591, ; hash 0xcc30590f, from name: HelloApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HelloApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 375
	...
	%struct.DSOCacheEntry {
		i64 3485166667, ; hash 0xcfbb6c4b, from name: aot-Plugin.NFC.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.20_name, ; name: libaot-Plugin.NFC.dll.so
		ptr null; void* handle (0x0)
	}, ; 380
	...
	%struct.DSOCacheEntry {
		i64 3538420472, ; hash 0xd2e802f8, from name: HelloApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HelloApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 382
	...
	%struct.DSOCacheEntry {
		i64 3912427425, ; hash 0xe932e7a1, from name: libaot-HelloApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HelloApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 419
	...
	%struct.DSOCacheEntry {
		i64 4071907422, ; hash 0xf2b4605e, from name: aot-Plugin.NFC
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.20_name, ; name: libaot-Plugin.NFC.dll.so
		ptr null; void* handle (0x0)
	}, ; 438
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [107 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
