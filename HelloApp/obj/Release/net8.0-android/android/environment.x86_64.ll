...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 107, ; uint32_t number_of_assemblies_in_apk (0x6b)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 462, ; uint32_t number_of_dso_cache_entries (0x1ce)
	i32 33555119, ; uint32_t android_runtime_jnienv_class_token (0x20002af)
	i32 100670508, ; uint32_t jnienv_initialize_method_token (0x6001c2c)
	i32 100670507, ; uint32_t jnienv_registerjninatives_method_token (0x6001c2b)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [462 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.77_name, ; name: libaot-Mono.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
		i64 130550379555063986, ; hash 0x1cfcee0e6ac08b2, from name: Microsoft.Extensions.Primitives.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.13_name, ; name: libaot-Microsoft.Extensions.Primitives.dll.so
		ptr null; void* handle (0x0)
	}, ; 2
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 160734707636988171, ; hash 0x23b0b5d6fc7690b, from name: aot-Plugin.NFC
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.20_name, ; name: libaot-Plugin.NFC.dll.so
		ptr null; void* handle (0x0)
	}, ; 4
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 558216167336417350, ; hash 0x7bf2ea589f79846, from name: HelloApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HelloApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 14
	%struct.DSOCacheEntry {
		i64 603416640204715261, ; hash 0x85fc43cbaf634fd, from name: libaot-System.Net.NameResolution
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.62_name, ; name: libaot-System.Net.NameResolution.dll.so
		ptr null; void* handle (0x0)
	}, ; 15
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 862236240028900946, ; hash 0xbf7474abf641e52, from name: aot-HelloApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HelloApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 22
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.75_name, ; name: libaot-Java.Interop.dll.so
		ptr null; void* handle (0x0)
	}, ; 24
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.14_name, ; name: libaot-Microsoft.Maui.Controls.Compatibility.dll.so
		ptr null; void* handle (0x0)
	}, ; 28
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.76_name, ; name: libaot-Mono.Android.Runtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 37
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1613559549492235853, ; hash 0x166483dc7b6c8e4d, from name: Plugin.NFC.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.20_name, ; name: libaot-Plugin.NFC.dll.so
		ptr null; void* handle (0x0)
	}, ; 39
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.74_name, ; name: libaot-System.dll.so
		ptr null; void* handle (0x0)
	}, ; 73
	%struct.DSOCacheEntry {
		i64 3010293356914467457, ; hash 0x29c6b5dbe09ae281, from name: libaot-HelloApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HelloApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 74
	...
	%struct.DSOCacheEntry {
		i64 3261252760888047966, ; hash 0x2d424c1b6f7e795e, from name: libaot-HelloApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HelloApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 81
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.65_name, ; name: libaot-System.Net.Sockets.dll.so
		ptr null; void* handle (0x0)
	}, ; 88
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3502583240674539256, ; hash 0x309bace660a476f8, from name: aot-Plugin.NFC.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.20_name, ; name: libaot-Plugin.NFC.dll.so
		ptr null; void* handle (0x0)
	}, ; 90
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.73_name, ; name: libaot-System.Xml.ReaderWriter.dll.so
		ptr null; void* handle (0x0)
	}, ; 95
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.78_name, ; name: libaot-System.Private.CoreLib.dll.so
		ptr null; void* handle (0x0)
	}, ; 98
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4033485942968731764, ; hash 0x37f9d218452ec874, from name: Plugin.NFC
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.20_name, ; name: libaot-Plugin.NFC.dll.so
		ptr null; void* handle (0x0)
	}, ; 107
	...
	%struct.DSOCacheEntry {
		i64 4190976302587607532, ; hash 0x3a2956be11d079ec, from name: HelloApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HelloApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 112
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.61_name, ; name: libaot-System.Net.Http.dll.so
		ptr null; void* handle (0x0)
	}, ; 176
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 9396255628307234750, ; hash 0x826634b5e0047fbe, from name: aot-HelloApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HelloApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 238
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libaot-Microsoft.Extensions.Logging.Abstractions.dll.so
		ptr null; void* handle (0x0)
	}, ; 269
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 12383018019083772018, ; hash 0xabd95147c2bfe072, from name: libaot-Plugin.NFC.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.20_name, ; name: libaot-Plugin.NFC.dll.so
		ptr null; void* handle (0x0)
	}, ; 309
	...
	%struct.DSOCacheEntry {
		i64 14650076265488095575, ; hash 0xcb4f86be78cc9957, from name: libaot-Plugin.NFC
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.20_name, ; name: libaot-Plugin.NFC.dll.so
		ptr null; void* handle (0x0)
	}, ; 369
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [107 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
...
@.env.1 = private unnamed_addr constant [16 x i8] c"major=marksweep\00", align 16
@.env.2 = private unnamed_addr constant [17 x i8] c"XAMARIN_BUILD_ID\00", align 16
@.env.3 = private unnamed_addr constant [37 x i8] c"c50c8a34-32cb-4f72-9b7d-ef8a07c557c6\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [23 x i8] c"libaot-HelloApp.dll.so\00", align 16
...
@.DSOCacheEntry.12_name = private unnamed_addr constant [56 x i8] c"libaot-Microsoft.Extensions.Logging.Abstractions.dll.so\00", align 16
@.DSOCacheEntry.13_name = private unnamed_addr constant [46 x i8] c"libaot-Microsoft.Extensions.Primitives.dll.so\00", align 16
@.DSOCacheEntry.14_name = private unnamed_addr constant [52 x i8] c"libaot-Microsoft.Maui.Controls.Compatibility.dll.so\00", align 16
...
@.DSOCacheEntry.20_name = private unnamed_addr constant [25 x i8] c"libaot-Plugin.NFC.dll.so\00", align 16
...
@.DSOCacheEntry.61_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Http.dll.so\00", align 16
@.DSOCacheEntry.62_name = private unnamed_addr constant [40 x i8] c"libaot-System.Net.NameResolution.dll.so\00", align 16
...
@.DSOCacheEntry.65_name = private unnamed_addr constant [33 x i8] c"libaot-System.Net.Sockets.dll.so\00", align 16
...
@.DSOCacheEntry.73_name = private unnamed_addr constant [38 x i8] c"libaot-System.Xml.ReaderWriter.dll.so\00", align 16
@.DSOCacheEntry.74_name = private unnamed_addr constant [21 x i8] c"libaot-System.dll.so\00", align 16
@.DSOCacheEntry.75_name = private unnamed_addr constant [27 x i8] c"libaot-Java.Interop.dll.so\00", align 16
@.DSOCacheEntry.76_name = private unnamed_addr constant [35 x i8] c"libaot-Mono.Android.Runtime.dll.so\00", align 16
@.DSOCacheEntry.77_name = private unnamed_addr constant [27 x i8] c"libaot-Mono.Android.dll.so\00", align 16
@.DSOCacheEntry.78_name = private unnamed_addr constant [37 x i8] c"libaot-System.Private.CoreLib.dll.so\00", align 16
